    ...
    <div class="<?php echo $bg['container']; ?> <?php echo $bg['content']; ?>">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8 text-center" data-stagger>
            <div>
                ...
                <div class="text-gray-300"><?php echo e(config('home_stat_1_text', '業界実績')); ?></div>
            </div>
            <div>
                ...
                <div class="text-gray-300"><?php echo e(config('home_stat_2_text', '導入実績')); ?></div>
            </div>
            <div>
                ...
                <div class="text-gray-300"><?php echo e(config('home_stat_3_text', '専門チーム')); ?></div>
            </div>
            <div>
                ...
                <div class="text-gray-300"><?php echo e(config('home_stat_4_text', '顧客満足度')); ?></div>
            </div>
        </div>
    </div>
</section>
